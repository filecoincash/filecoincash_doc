...
#### [The second version](https://github.com/filecoincash/lotus/releases/tag/v0.5.7-beta2)  released on september 23 made the following improvements:
- Package is modified to 4G and 16G version.
- The number of packaging layers in P1 part is modified to 2 layers. (2 layers are convenient and quick to produce blocks, and will be adjusted to 5 layers later)

#### [The first version](https://github.com/filecoincash/lotus/releases/tag/v0.5.7-beta)  released on september 19 made the following improvements:
